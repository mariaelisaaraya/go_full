...
func main() {
	...
	for {
		...
		//
		validateUserInput(firtsName, lastName, email, userTickets, remainingTickets)
...
func validateUserInput(firtsName string, lastName string, email string, userTickets uint, remainingTickets uint) {
