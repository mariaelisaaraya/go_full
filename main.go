...
func main() {
	...
	for {
		...
		isValidName, isValidEmail, isValidTicketNumber := validateUserInput(firtsName, lastName, email, userTickets)
...
func validateUserInput(firtsName string, lastName string, email string, userTickets uint) (bool, bool, bool) {
